...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-white/10 bg-slate-900/60 backdrop-blur-xl">
      <div className="flex h-16 items-center px-6">
        <h1 className="text-xl font-bold tracking-tight text-gradient flex items-center gap-2">
      ...
      <nav className="flex-1 space-y-1 px-3 py-4">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <svg
                className={`h-5 w-5 ${isActive ? "text-fuchsia-400 drop-shadow-[0_0_8px_rgba(236,72,153,0.8)]" : "text-slate-500"}`}
